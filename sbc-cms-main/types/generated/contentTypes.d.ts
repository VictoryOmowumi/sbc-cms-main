...
export interface ApiEventEvent extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    Grade: Schema.Attribute.Enumeration<['Scheduled', 'Completed', 'Canceled']>;
...
export interface ApiHomescreenHomescreen extends Struct.SingleTypeSchema {
  collectionName: 'homescreens';
  info: {
    singularName: 'homescreen';
    pluralName: 'homescreens';
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::homescreen.homescreen': ApiHomescreenHomescreen;
